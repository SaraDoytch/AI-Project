...
#     full_prompt = (
#         f"צור שיעור קצר באורך 8-10 שורות בנושא '{category}'"
#         f" בתת נושא '{sub_category}'"
#     )
#     if prompt_text.strip():
#         full_prompt += f", בהתבסס על השאלה: {prompt_text}"

#     full_prompt += "\nהשיעור צריך להיות בעברית פשוטה וברורה."
...
#             headers=headers,
#             json={
#                 "model": "gpt-4o",  # אפשר גם gpt-3.5-turbo אם צריך
#                 "messages": [
#                     {"role": "system", "content": "אתה מורה מקצועי שמעביר שיעורים קצרים."},
...
#             },
#             timeout=20.0,
#             verify=False  # הסרה אם SSL תקין אצלך
#         )
