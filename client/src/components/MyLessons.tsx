...
import { useGetCategoriesQuery } from "../stores/Slices/categoryApiSlice"; // או הנתיב שלך

// ה־interface של Prompt (ייבא או הגדר כאן אם צריך)
// interface Prompt {
//   _id: string;
//   user_id: string;
        ...
        {lessons.map((lesson) => (
          <React.Fragment key={lesson._id}>
            ...
            >
                            ...
                            {/* <ListItemText
                                primary={lesson.prompt.slice(0, 40) + "..."}
                                secondary={`קטגוריה: ${lesson.category_id || "לא זמין"}`}
                            /> */}
                            {/* <ListItemText
  primary={lesson.prompt.slice(0, 40) + "..."}
